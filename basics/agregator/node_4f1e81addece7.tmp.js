...
let weatherFile = fileStream.readFileSync("./cache/weatherForecast.json");

let WeatherFromFile = JSON.parse(weatherFile);

app.get("/", function (request, response) {
	response.render("template.ejs", { forecast: WeatherFromFile.forecast });
});
